...
- Korpora 라이센스는 Creative Commons License(CCL) 4.0의 [CC-BY](https://creativecommons.org/licenses/by/4.0)입니다. 이 라이센스는 Korpora 패키지 및 그 부속물에 한정되며 각 데이터는 데이터별로 라이센스가 별도로 적용됩니다.
- 이용자는 다음의 권리를 갖습니다.
