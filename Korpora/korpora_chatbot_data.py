...
class KoreanChatbotCorpus(Korpus):
    ...
    def __init__(self, root_dir=None, force_download=False):
        ...
        local_path = os.path.join(os.path.abspath(root_dir), corpus_information[0]['destination'])
        fetch(corpus_information[0]['url'], local_path, 'korean_chatbot_data', force_download)
